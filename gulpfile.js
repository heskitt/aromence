...
function images() {
	return src(path.src.images)
		...
		.pipe(src(path.src.sprites + "sprite.svg"))
		.pipe(dest(path.build.images))
}
function favicon() {
...
// Sprites (should be called manually)-------------
gulp.task('svgSprite', function () {
	return gulp.src([src_folder + '/img/icons/*.svg'])
		.pipe(svgSprite({
			mode: {
				symbol: {
					sprite: "../sprite.svg",
